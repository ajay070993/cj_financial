...
<div class="main <?php if($this->session->userdata('data-type-collapse') == 0) echo 'mainSmall'; ?>">
   ...
   <div class="scrollContainer"> 
    <div class="spread">
        <form id="convert_form" class="form-signin ajax_form" action="<?php echo base_url('Bank_statement/detectTplConvertBankStatement'); ?>" method="post">
            <!-- <div class="row">
                <div class="col-sm-6">
				...
				<div class="content">
					...
					<div class="downloadBox" style="display: none">
						...
						<a id="dwnld_excel" href="<?php echo base_url()?>Bank_statement/createXLSBankStatement" title="Download File">
							<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 25.596 25.596"><path class="a" d="M25.35 12.798A12.548 12.548 0 1012.798 25.35 12.563 12.563 0 0025.35 12.798zm-23.843 0a11.294 11.294 0 1111.291 11.294A11.307 11.307 0 011.504 12.798z"/><path class="a" d="M13.243 18.694l3.526-3.526a.626.626 0 00-.885-.885l-2.456 2.456V7.348a.63.63 0 10-1.259 0v9.386l-2.456-2.456a.626.626 0 00-.885.885l3.526 3.526a.636.636 0 00.89.005z"/></svg>
							<span>Download</span>
						</a>
					</div>
				</div>
...
if(data.multiple_account==true && data.queue_no>0 && data.multiple_process==true){
    ...
    if(data.queue_no==1){
    	...
    	setTimeout(function(){ createXLSBankStatement(data_1); }, 10000);
    }else if(data.queue_no==2){
    	setTimeout(function(){ createXLSBankStatement(data_2); }, 20000);
    }else if(data.queue_no==3){
    	setTimeout(function(){ createXLSBankStatement(data_3); }, 30000);
    }else if(data.queue_no==4){
    	setTimeout(function(){ createXLSBankStatement(data_4); }, 40000);
    }else if(data.queue_no==5){
    	setTimeout(function(){ createXLSBankStatement(data_5); }, 50000);
    }else if(data.queue_no==6){
    	setTimeout(function(){ createXLSBankStatement(data_6); }, 60000);
    }else if(data.queue_no==7){
    	setTimeout(function(){ createXLSBankStatement(data_7); }, 70000);
    }/*else{
