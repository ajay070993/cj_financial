...
<div class="logo">
	...
	<img height="60px" src="<?php echo $this->config->item('admin_assets'); ?>global/img/sport_logo.png" alt="logo" class="logo-default"/>
	</a>
</div>
<!-- END LOGO -->
...
<div class="content"  style="width:500px; text-align: center;" >
	...
	<div class="forget-password">
		<span>Click <a style="color: #fff;" href="<?php echo site_url('admin/forgot-password'); ?>" id="forget-password">
