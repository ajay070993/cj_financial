...
<div class="modal fade customModal" id="addUser">
    <form class="form-signin ajax_form form-fields" id="ajax_form" action="<?php echo site_url('Users/addUser'); ?>" method="post">
...
<div class="modal fade customModal" id="editUser">
	<form class="form-signin ajax_form form-fields" id="ajax_form" action="<?php echo site_url('update-user'); ?>" method="post" autocomplete="off">
    <div class="modal-dialog modal-lg modal-dialog-centered" style="max-width: 660px;margin-top: unset">
      <div class="modal-content">
          <div class="modal-header">
            <h5>Edit User</h5>
...
<div class="modal fade customModal changePass" id="changePassword">
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered" style="margin-top: unset;z-index: 2000;">
      <div class="modal-content">
        ...
        <!-- Modal body -->
        <div class="modal-body">
            <form class="form-signin ajax_form form-fields" id="ajax_form" action="<?php echo site_url('update-password'); ?>" method="post" autocomplete="off">
                <div class="row">
                    <div class="col-sm-12">
                        <div class="form-group">
...
<div class="modal fade customModal" id="confirmDelete">
    <div class="modal-dialog modal-lg modal-dialog-centered" style="margin-top: unset;">
      <div class="modal-content">
        <!-- Modal body -->
        <div class="modal-body">
        <form class="form-signin ajax_form form-fields" id="ajax_form" action="<?php echo site_url('delete-user'); ?>" method="post" autocomplete="off">
...
$('#datatable').DataTable({
    ...
    "language": {
      ...
      "ajax": {
          "url": "<?php echo base_url('Users/fetch_users_detail'); ?>",
          "type": "POST"
      },
