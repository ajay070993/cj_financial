...
class Users extends CI_Controller {
    ...
    function index() {
        $output['users'] = $this->tpl_user->getAllUsers();
    ...
    function addUser(){
        ...
        if ($this->form_validation->run()) {
            ...
            $this->tpl_user->addNewUser($user_data);
    ...
    function editUser(){
        ...
        $userDetails = $this->tpl_user->editUser($id);
    ...
    function updateUser(){
        ...
        if ($this->form_validation->run()) {
            ...
            $this->tpl_user->updateRecordByUserId($edit_id,$user_data);
    ...
    function updatePassword(){
        ...
        if ($this->form_validation->run()) {
            ...
            $salt = 'Ijxo1A16';
            $user_data['password'] = md5(md5($password).md5($salt));
            $this->tpl_user->updateRecordByUserId($p_edit_id,$user_data);
    ...
    function deleteUser(){
        ...
        if($d_edit_id>0){
            if($this->tpl_user->deleteRecordByUserId($d_edit_id)){
    ...
    function fetch_users_detail(){
        ...
        $fetch_data = $this->tpl_user->make_datatables();
        /*echo"<pre>";
         print_r($fetch_data);
         die;*/
        $data = array();
        ...
        $output = array(
            ...
            "recordsTotal"          =>      $this->tpl_user->get_all_data(),
            "recordsFiltered"     =>     $this->tpl_user->get_filtered_data(),
            "data"                    =>     $data
        );
